/*$('#file-5').fileinput(fileProyekGallery);
...
$('#file-5').fileinput({
    ...
    initialPreview: proyekGalleryinitialPreview,
    initialPreviewConfig: proyekGalleryinitialPreviewConfig,
    showRemove: false,
...
$('#file-6').fileinput({
    ...
    uploadClass: 'btn btn-primary',
    uploadLabel: 'Upload All',
    initialPreview: proyekDenahinitialPreview,
    initialPreviewConfig: proyekDenahinitialPreviewConfig,
    showRemove: false,
...
$(document).ready(function(){
    ...
    $.ajax({
        ...
        success:function(result){
            ...
            $("#province").select2("val", provinceID);
        }
    });
    ...
    $.ajax({
        ...
        success:function(result){
            ...
            $("#propertyType").select2("val", propertyTypeID);
        }
    });
    ...
    $.ajax({
        ...
        success:function(result){
            ...
            $("#developerName").select2("val", developerID);
        }
    });
    ...
    /*$("#postProyek").validate({
        ...
        submitHandler: function(form) {
            ...
            var url = "/proyek-developer/update";
