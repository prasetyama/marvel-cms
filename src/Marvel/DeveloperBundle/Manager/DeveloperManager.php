...
class DeveloperManager{
  ...
  public function insertDeveloper(array $param = array(), $fileName){
  ...
  public function updateDeveloper(array $param = array(), $fileName){
  ...
  public function showProyekGallery($param, $table){
